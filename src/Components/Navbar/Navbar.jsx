...
import horizonLogo from "../../../public/horizon-logo.svg";
                        ...
                        <div className="left-side">
                            <Link className="navbar-brand" href="/">
                                <Image
                                    loading="lazy"
                                    src={horizonLogo}
                                    alt="Horizon Collaboration"
                                    className="logo modern-logo"
                                    width={180}
                                    height={60}
                            ...
                            <span onClick={handleShow} id="hamburg" className="modern-hamburger">
